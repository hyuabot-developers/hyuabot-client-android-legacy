        ...
        fun bind(key: Int, value: List<CalendarDatabaseItem>) {
            when(key) {
                ...
                4 -> {
                    ...
                    binding.scheduleGroupName.setBackgroundColor(ResourcesCompat.getColor(context.resources, R.color.primaryTextColor, null))
                    binding.scheduleGroupName.setTextColor(ResourcesCompat.getColor(context.resources, R.color.cardBackground, null))
                }
            }
